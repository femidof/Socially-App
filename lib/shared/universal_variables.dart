...
class UniversalVariables {
  ...
  static const Color gradientColorStarthmm = Color(0xffA800CB);
  static const Color gradientColorEnd = Color(0xff0184dc);
  static const Color gradientColorEndhmm = Color(0xff030917);

  static const Color mainColor = Color(0xff030917);
  ...
  static const Gradient fabGradient = LinearGradient(
      colors: [gradientColorStarthmm, gradientColorEndhmm],
